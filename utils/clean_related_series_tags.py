...
"""Script to clean related series tags in DICOM data."""
...
def get_parser():
    """Get parser object for script `clean_related_series_tags.py`."""
...
def main():
    """Main function of the `clean_related_series_tags.py` script."""
